...
function extractParams(path, parts, leaf) {
  ...
  for (; nodeIndex < list.length; partIndex++, nodeIndex++, pathIndex++, segmentCount++) {
    ...
    if (node.kind === 1) {
      ...
      const n2 = node;
      const value = path.substring(currentPathIndex + (((_i = n2.prefix) == null ? void 0 : _i.length) ?? 0), path.length - (((_j = n2.suffix) == null ? void 0 : _j.length) ?? 0));
  ...
  const router = useRouter();
  {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(CatchBoundary, {
      ...
      onCatch: (error, errorInfo) => {
        var _a3;
        if (isNotFound(error)) (_a3 = props.onCatch) == null ? void 0 : _a3.call(props, error, errorInfo);
        else throw error;
      },
      errorComponent: ({ error }) => {
        var _a3;
        if (isNotFound(error)) return (_a3 = props.fallback) == null ? void 0 : _a3.call(props, error);
        else throw error;
      },
...
var Match = reactExports.memo(function MatchImpl({ matchId }) {
  ...
  const router = useRouter();
  {
    const match2 = (_a3 = router.stores.matchStores.get(matchId)) == null ? void 0 : _a3.get();
    if (!match2) {
      invariant();
    }
    const routeId = match2.routeId;
    const parentRouteId = (_b2 = router.routesById[routeId].parentRoute) == null ? void 0 : _b2.id;
...
function MatchView({ router, matchId, resetKey, matchState }) {
  ...
  const routeNotFoundComponent = route.isRoot ? route.options.notFoundComponent ?? ((_a3 = router.options.notFoundRoute) == null ? void 0 : _a3.options.component) : route.options.notFoundComponent;
  const resolvedNoSsr = matchState.ssr === false || matchState.ssr === "data-only";
  const ResolvedSuspenseBoundary = (!route.isRoot || route.options.wrapInSuspense || resolvedNoSsr) && (route.options.wrapInSuspense ?? PendingComponent ?? (((_b2 = route.options.errorComponent) == null ? void 0 : _b2.preload) || resolvedNoSsr)) ? reactExports.Suspense : SafeFragment;
...
var MatchInner = reactExports.memo(function MatchInnerImpl({ matchId }) {
  ...
  const getMatchPromise = (match2, key2) => {
    var _a4;
    return ((_a4 = router.getMatch(match2.id)) == null ? void 0 : _a4._nonReactive[key2]) ?? match2._nonReactive[key2];
  };
  {
    const match2 = (_a3 = router.stores.matchStores.get(matchId)) == null ? void 0 : _a3.get();
    if (!match2) {
    ...
    const remountDeps = (_b2 = router.routesById[routeId2].options.remountDeps ?? router.options.defaultRemountDeps) == null ? void 0 : _b2({
      routeId: routeId2,
...
var Outlet = reactExports.memo(function OutletImpl() {
  ...
  let childMatchId;
  {
    ...
    childMatchId = parentIndex >= 0 ? (_a3 = matches[parentIndex + 1]) == null ? void 0 : _a3.id : void 0;
  }
...
var ScriptBuffer = class {
  ...
  */
  flush() {
    ...
    if (scriptsToInject && ((_a3 = this.router) == null ? void 0 : _a3.serverSsr)) this.router.serverSsr.injectScript(scriptsToInject);
  }
  takeAll() {
...
function attachRouterServerSsrUtils({ router, manifest: manifest2, getRequestAssets, includeUnmatchedRouteAssets = true }) {
  router.ssr = { get manifest() {
    ...
    if (!(requestAssets == null ? void 0 : requestAssets.length)) return manifest2;
    return {
      ...manifest2,
      routes: {
        ...manifest2 == null ? void 0 : manifest2.routes,
        [rootRouteId]: {
          ...(_a3 = manifest2 == null ? void 0 : manifest2.routes) == null ? void 0 : _a3[rootRouteId],
          assets: [...requestAssets, ...((_c = (_b2 = manifest2 == null ? void 0 : manifest2.routes) == null ? void 0 : _b2["__root__"]) == null ? void 0 : _c.assets) ?? []]
        }
      }
    };
  } };
  ...
  router.serverSsr = {
    ...
    dehydrate: async (opts) => {
      ...
      if (manifest2) {
        ...
        if ((_a3 = opts == null ? void 0 : opts.requestAssets) == null ? void 0 : _a3.length) {
          const existingRoot = manifestToDehydrate.routes[rootRouteId];
          manifestToDehydrate.routes[rootRouteId] = {
            ...existingRoot,
            assets: [...opts.requestAssets, ...(existingRoot == null ? void 0 : existingRoot.assets) ?? []]
          };
        }
      }
      ...
      const lastMatchId = (_b2 = matchesToDehydrate[matchesToDehydrate.length - 1]) == null ? void 0 : _b2.id;
      if (lastMatchId) dehydratedRouter.lastMatchId = dehydrateSsrMatchId(lastMatchId);
      const dehydratedData = await ((_d = (_c = router.options).dehydrate) == null ? void 0 : _d.call(_c));
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DVc1ftej.js");
...
const manifest = {
  ...
  "57e57f9ad3a052abb4ff80e36000664d4271aaf52959c15686bf6cd3dd155e55": {
    ...
    importer: () => import("./assets/auth-CLGm3pIS.js")
  },
...
async function executeMiddleware$1(middlewares, env, opts) {
  var _a3;
  let flattenedMiddlewares = flattenMiddlewares([...((_a3 = getStartOptions()) == null ? void 0 : _a3.functionMiddleware) || [], ...middlewares]);
  if (env === "server") {
    const startContext = getStartContextServerOnly({ throwIfNotFound: false });
    if (startContext == null ? void 0 : startContext.executedRequestMiddlewares) flattenedMiddlewares = flattenedMiddlewares.filter((m2) => !startContext.executedRequestMiddlewares.has(m2));
  }
  ...
  return {
    ...
    options: {
      ...
      client: async ({ next, sendContext, fetch, ...ctx }) => {
        ...
        return next(await ((_a3 = options.extractedFn) == null ? void 0 : _a3.call(options, payload)));
      },
...
async function transformManifestAssets(source, transformFn, _opts) {
  ...
  for (const route of Object.values(manifest2.routes)) {
    ...
    if (route.assets) {
      for (const asset of route.assets) if (asset.tag === "link" && ((_a3 = asset.attrs) == null ? void 0 : _a3.href)) {
...
function buildManifestWithClientEntry(source) {
  ...
  return { routes: {
    ...
    [rootRouteId]: {
      ...baseRootRoute,
      assets: [...(baseRootRoute == null ? void 0 : baseRootRoute.assets) || [], scriptTag]
    }
  } };
}
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-BVmsU_2r.js").then((n2) => n2.o),
...
function createStartHandler(cbOrOptions) {
  ...
  const startRequestResolver = async (request, requestOpts) => {
    ...
    try {
      ...
      if (router && !cbWillCleanup) (_b2 = router.serverSsr) == null ? void 0 : _b2.cleanup();
      router = null;
    }
  };
